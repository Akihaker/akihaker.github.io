...
<body>
	...
	<!-- <script>
		...
		Иначе - псевдослучайна, при том же ключе в новой сессии сгенирируются те же примеры<br>
		Добавление введущих нулей ни к чему не приводит. Ключ «0123» от «123» ничем не отличается<br>
		Кнопка <span class="spanbutton" style="color: white;">R</span> придумает случайный ключ<br>
		<h3>Примеры</h3>
		Это пример линейного неравенства со сложностью 2.
		...
		<div id="answer_ex" style="margin-bottom: 5px; display: block; text-align: right;"></div>
		...
		</p>При нажатии на кнопку <div class="LaTeX">[LaTeX]</div> пример копируется в буфер обмена<br>
		...
		<p>Копирование ответа не предусмотрено</p>`;
